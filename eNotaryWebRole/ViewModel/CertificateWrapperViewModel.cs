...
enum WinTrustDataStateAction: uint
{
    ...
    {
        Success= 0,
        ProvideUnknown=0x800b0001 , // The trust provider is not recognized on this system
    ...
    class WinTrustFileInfo
    {
        ...
        IntPtr pszFilePath; // requires , file name to be verified
        IntPtr hFile = IntPtr.Zero; // optional, open handle to FilePath
        IntPtr pgKnownSybject = IntPtr.Zero; //optional, subject type if it is known
    ...
    // Wrapper class
    public sealed class CertificateWrapperViewModel
    {
    ...
    private CertificateWrapperViewModel() { }
    }
